...
import { intl } from "@redux/actions/intl";
...
@connect(
  (state) => ({
    user: state.user,
    intlLanguage: state.intlLanguage,
  }),
  {
    logout,
    resetUser,
...
class PrimaryLayout extends Component {
  ...
  render() {
    ...
    const intlMenu = (
      <Menu selectedKeys={this.props.language} onClick={this.toggleIntl}>
